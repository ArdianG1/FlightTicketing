...
public class CreateBooking extends VerticalLayout {
    ...
    private void createForm() {
        ...
        add(fromComboBox, toComboBox, departureDatePicker, arriveDatePicker, SearchButton); // Note: Code harus teratur dengan code diatas karena menggunakan extends VerticalLayout (atas ke bawah)
        ...
        add(fromComboBox, toComboBox, departureDatePicker, arriveDatePicker, SearchButton, grid);
    ...
    private static class CreateBookingFormLayout extends FormLayout {
        ...
        public void setSchedueDTO(ScheduleDTO scheduleDTO) {
        ...
        private static ComponentRenderer<CreateBookingFormLayout,ScheduleDTO> createBookingRenderer() {
            return new ComponentRenderer<>(CreateBookingFormLayout::new,CreateBookingFormLayout::setSchedueDTO);
        }
    }
}
